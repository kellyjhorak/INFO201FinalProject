...
```{r, echo=FALSE}
knitr::include_graphics("gdp_comp_rate_female.png")
knitr::include_graphics("gdp_comp_rate_male.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("gdp_unemployment.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("gdp_oosr_female.png")
knitr::include_graphics("gdp_oosr_male.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("gdp_education_gap.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("gdp_map.png")
```
