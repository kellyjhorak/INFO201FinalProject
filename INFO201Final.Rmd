...
```{r}
completionRate <- subset(gdp_global_education, select =c("Country.Territory", "Completion_Rate_Primary_Male", "Completion_Rate_Primary_Male"))
...
## find income classes. make incomce classes and sort each country into its own bin for gdp
